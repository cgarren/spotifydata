...
* New Singles
* New Albums
* Sort new/popular/playlist/library music by attributes (find the most dancable top tracks, see which tracks were mastered the loudest, find out which songns are inn the key of C, etc...)
